          ...
          <form @submit.prevent="addToCart(selectProductInput)">
            ...
            <div
              ...
              <input
                ...
                min="1"
                aria-label="Quantity"
                class="bg-white border rounded-lg flex text-left p-3.5 w-20 gap-4 items-center justify-center focus:outline-none" />
            ...
            <a
              ...
              target="_blank"
              class="rounded-lg flex font-bold bg-gray-800 text-white text-center min-w-[150px] p-3.5 gap-4 items-center justify-center focus:outline-none">
